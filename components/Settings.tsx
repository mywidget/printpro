  ...
  return (
    <div className="p-8 max-w-6xl relative pb-24">
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-500">Kelola identitas, API Multi-Site, dan sinkronisasi data</p>
      </div>
      
      {showToast && (
        <div className="fixed top-24 right-8 bg-emerald-600 text-white px-6 py-3 rounded-2xl shadow-xl z-50 flex items-center gap-3">
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm space-y-6">
            ...
            <div className="pt-6 border-t border-slate-100">
              ...
              <div className="space-y-3">
                ...
                {(!localSettings.apiEndpoints || localSettings.apiEndpoints.length === 0) && (
                  <p className="text-[10px] text-slate-400 italic bg-slate-50 p-4 rounded-2xl border border-dashed text-center uppercase tracking-widest font-black">Belum ada API Site terdaftar.</p>
                )}
              </div>
            </div>
            
            <div className="pt-4 flex justify-end">
              <button onClick={handleSave} disabled={isSaving} className="bg-indigo-600 text-white px-8 py-3.5 rounded-2xl font-black text-sm hover:bg-indigo-700 active:scale-95 disabled:opacity-50">
